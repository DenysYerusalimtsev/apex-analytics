...
case class PacketSessionData(
    ...
    sliProNativeSupport: Int,
    numMarshalZones: Int,
    marshalZones: List[MarshalZone],
    safetyCarStatus: SafetyCarStatus,
    networkGame: Int,
    numWeatherForecastSamples: Int,
    weatherForecastSamples: List[WeatherForecastSample],
    forecastAccuracy: Int,
    aiDifficulty: Int,
    seasonLinkIdentifier: Long,
    weekendLinkIdentifier: Long,
    sessionLinkIdentifier: Long,
    pitStopWindowIdealLap: Int,
    pitStopWindowLatestLap: Int,
    pitStopRejoinPosition: Int,
    steeringAssist: Int,
    brakingAssist: Int,
    gearboxAssist: Int,
    pitAssist: Int,
    pitReleaseAssist: Int,
    ERSAssist: Int,
    DRSAssist: Int,
    dynamicRacingLine: Int,
    dynamicRacingLineType: Int,
    gameMode: Int,
    ruleSet: Int,
    timeOfDay: Long,
    sessionLength: Int
